        ...
        <div class="container">
          <div class="row justify-content-between">
            <div class="col-lg-6 col-md-6">
              <div class="header-top-left d-flex">
                ...
                <div class="email-part">
                  <a href="mailto:info@winandwin.ae"><i class="fa fa-envelope"></i>info@winandwin.ae</a>
                </div>
              </div>
            </div>
			...
			<div class="col-lg-2 col-md-2" style='text-align: center;'>
			   <select style='border:0px;color:rgba(51, 55, 69, 0.8);'>
			      <option>AED</option>
			   </select>
			</div>
          </div>
          ...
          <nav class="navbar navbar-expand-xl">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav main-menu ml-auto">
                ...
                <li class="menu_has_children"><a href="#0">Draws</a>
                  <ul class="sub-menu">
                    <li><a href="{{ url('winners') }}">Winners</a></li>
                    <li><a href="{{ url('past-draw-results') }}">Past Draw Results</a></li>
                    <li><a href="{{ url('weekly-live-stream') }}">Weekly Live Stream</a></li>
                  </ul>
                </li>
              ...
              <div class="header-join-part">
                <a href="{{ url('register-user') }}" class="cmn-btn">Register</a>
              </div>
              @else 
              <div class="header-join-part">
