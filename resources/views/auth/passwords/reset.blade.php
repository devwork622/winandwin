   ...
   <div class="row justify-content-center">
      <div class="col-lg-8 col-md-8 col-sm-12">
         <div class="register_div">
            ...
            @endif
            <form method="POST" id="resetform" action="{{ route('user_reset_password') }}" class="registration-form cmn-frm">
               ...
               <div class='frm-group'>
                  <input type="submit" id="reset_password_submit" class="btn verify_btn" value="{{ __('Reset Password') }}">
               </div>
            </form>
